...
- **Member discovery specs**: the members list, the search box's `@` mode and the trade composer each reaching another member's inventory, plus the community member profile they now route through. (#349)
