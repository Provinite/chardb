...
export class ImageModerationAction {
  ...
  @Field(() => ModerationRejectionReason, {
    nullable: true,
    description: "The reason for rejection (if rejected)",
  })
...
export class ImageModerationQueueItem {
  ...
  @Field({
    nullable: true,
    description: "Title of the associated media (if any)",
  })
  mediaTitle?: string;

  @Field({
    nullable: true,
    description: "Name of the associated character (if any)",
  })
  characterName?: string;

  @Field(() => ID, {
    nullable: true,
    description: "ID of the associated character (if any)",
  })
  characterId?: string;

  @Field({
    nullable: true,
    description: "Name of the associated community (if any)",
  })
  communityName?: string;

  @Field(() => ID, {
    nullable: true,
    description: "ID of the associated community (if any)",
  })
  communityId?: string;
}
