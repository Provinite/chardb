...
import { IsString, IsUUID, IsInt, Min, IsOptional, Matches, MinLength, MaxLength } from 'class-validator';
...
export class CreateInviteCodeInput {
  ...
  @Field(() => String, { description: 'The invite code string (alphanumeric and hyphens only)' })
  @IsString()
  ...
  @Field(() => ID, { description: 'The ID of the user who is creating this invite code' })
...
export class UpdateInviteCodeInput {
  /** Maximum number of times this invite code can be claimed */
  @Field(() => Int, { description: 'Maximum number of times this invite code can be claimed', nullable: true })
  @IsOptional()
  @IsInt()
  @Min(1, { message: 'Max claims must be at least 1' })
  maxClaims?: number;
...
export class ClaimInviteCodeInput {
  ...
  @Field(() => ID, { description: 'The ID of the user who is claiming this invite code' })
