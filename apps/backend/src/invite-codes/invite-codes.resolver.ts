...
export class InviteCodesResolver {
  ...
  async findAll(
    ...
    const serviceResult = await this.inviteCodesService.findAll(
      first,
      after,
      communityId,
    );
  ...
  async findByCreator(
    ...
    const serviceResult = await this.inviteCodesService.findByCreator(
      creatorId,
      first,
      after,
    );
  ...
  async findByRole(
    ...
    const serviceResult = await this.inviteCodesService.findByRole(
      roleId,
      first,
      after,
    );
