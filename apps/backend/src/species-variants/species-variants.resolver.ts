...
export class SpeciesVariantsResolver {
  ...
  async createSpeciesVariant(
    ...
    const serviceInput = mapCreateSpeciesVariantInputToService(
      createSpeciesVariantInput,
    );
  ...
  async findAll(
    ...
    const serviceResult = await this.speciesVariantsService.findAll(
      first,
      after,
    );
  ...
  async findBySpecies(
    ...
    const serviceResult = await this.speciesVariantsService.findBySpecies(
      speciesId,
      first,
      after,
    );
  ...
  async updateSpeciesVariant(
    ...
    const serviceInput = mapUpdateSpeciesVariantInputToService(
      updateSpeciesVariantInput,
    );
    const prismaResult = await this.speciesVariantsService.update(
      id,
      serviceInput,
    );
    return mapPrismaSpeciesVariantToGraphQL(prismaResult);
  ...
  async resolveSpecies(
    ...
    try {
      const prismaResult = await this.speciesService.findOne(
