...
export function mapPrismaTraitListEntryToGraphQL(prismaTraitListEntry: PrismaTraitListEntry): TraitListEntry {
  return {
    ...
    defaultValueString: prismaTraitListEntry.defaultValueString,
    defaultValueInt: prismaTraitListEntry.defaultValueInt,
    defaultValueTimestamp: prismaTraitListEntry.defaultValueTimestamp,
