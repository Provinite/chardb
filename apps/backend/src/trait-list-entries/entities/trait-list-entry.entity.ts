...
export class TraitListEntry {
  ...
  @Field(() => ID, {
    description: 'Unique identifier for the trait list entry',
  })
  id: string;
...
export class TraitListEntryConnection {
  ...
  @Field(() => [TraitListEntry], {
    description: 'List of trait list entries in this connection',
  })
  ...
  @Field({
    description: 'Whether there are more trait list entries after this page',
  })
  hasNextPage: boolean;

  /** Whether there are more trait list entries before this page */
  @Field({
    description: 'Whether there are more trait list entries before this page',
  })
