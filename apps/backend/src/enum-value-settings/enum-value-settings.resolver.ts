...
export class EnumValueSettingsResolver {
  ...
  async createEnumValueSetting(
    ...
    const serviceInput = mapCreateEnumValueSettingInputToService(
      createEnumValueSettingInput,
    );
    const prismaResult =
      await this.enumValueSettingsService.create(serviceInput);
  ...
  async findAll(
    ...
    const serviceResult = await this.enumValueSettingsService.findAll(
      first,
      after,
    );
  ...
  async findBySpeciesVariant(
    ...
    const serviceResult =
      await this.enumValueSettingsService.findBySpeciesVariant(
        speciesVariantId,
        first,
        after,
      );
  ...
  async findByEnumValue(
    ...
    const serviceResult = await this.enumValueSettingsService.findByEnumValue(
      enumValueId,
      first,
      after,
    );
  ...
  async updateEnumValueSetting(
    ...
    const serviceInput = mapUpdateEnumValueSettingInputToService(
      updateEnumValueSettingInput,
    );
    const prismaResult = await this.enumValueSettingsService.update(
      id,
      serviceInput,
    );
    return mapPrismaEnumValueSettingToGraphQL(prismaResult);
  ...
  async resolveEnumValue(
    ...
    const prismaEnumValue = await this.enumValuesService.findOne(
      enumValueSetting.enumValueId,
    );
